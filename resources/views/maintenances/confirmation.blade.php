...
@section('title', 'Confirmation Of Maintenances')
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Confirmation Of Maintenances</h4>
                </div>
                <div class="card-body">
                    <table id="confirmationMaintenances_table" class="table table-bordered">
                        <thead>
                            <th>No</th>
                            <th>Item Name</th>
                            <th>Serial Number</th>
...
@section('scripts')
    <script src="{{ URL::asset('js/confirmation-maintenance.js') }}"></script>
@endsection
